# GitHub Release Guide - UTMS v1.1.0
...
git commit -m "docs: add distribution guide and packaging script for v1.1.0 release"
```
...
```bash
# Create an annotated tag for version 1.1.0
git tag -a v1.1.0 -m "Release v1.1.0 - UTMS Beta Testing Release
...
3. **Configure the Release**:
   - **Tag**: Select `v1.1.0` (or type it if not created yet)
   - **Target**: `main` branch
   - **Release title**: `UTMS v1.1.0 - Beta Testing Release`

4. **Write Release Notes** (copy the template below):

```markdown
# 🎓 UTMS v1.1.0 - Beta Testing Release
...
| `student01_cse_new` | Students | Test application workflow (Pass: `Student123!`) |
...
gh release create v1.1.0 \
  --title "UTMS v1.1.0 - Beta Testing Release" \
...
```
https://github.com/vardareg/utms-project/releases/tag/v1.1.0
```
...
2. Drag and drop `utms-project-v1.1.0.tar.gz` into the "Attach binaries" section
...
# Create a new GitHub Release for v1.1.1
```
